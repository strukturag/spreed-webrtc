...
define([], function() {
	...
	return ["$scope", "$modalInstance", "contactData", "data", "contacts", 'dialogs', 'translation', 'mediaStream', 'buddyData', '$timeout', function($scope, $modalInstance, contactData, data, contacts, dialogs, translation, mediaStream, buddyData, $timeout) {
